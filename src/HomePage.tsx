      ...
      >
        <div className="container mx-auto p-4 ">
          ...
          <img
            src={profilepic}
            alt="Profile"
            className="w-full/2 h-[60vh] rounded-md mx-auto mt-4  shadow-[inset_0_-2px_0px] shadow-cyan-500/50 opacity-85 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 cursor-pointer "
          />
          ...
          >
            <img
              src={linkedIn}
              alt="Github"
              className="w-10 h-10 mt-10 rounded-full mx-auto object-contain shadow-xl/30 shadow-cyan-500/50 opacity-85 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 cursor-pointer"
            />
